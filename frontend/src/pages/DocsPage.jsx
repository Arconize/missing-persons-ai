...
const sections = [
  {
    ...
    content: `سامانه FindMe یک پلتفرم آنلاین برای کمک به یافتن افراد گمشده و اتصال دوباره آن‌ها به خانواده‌هایشان است.

هر فرد گمشده، خانواده‌ای دارد که با اشتیاق منتظر بازگشت اوست. این سامانه با فراهم کردن یک فضای متمرکز و قابل اعتماد، به شهروندان امکان می‌دهد اطلاعات افراد گمشده را ثبت کنند، جستجو کنند، و در صورت یافتن آن‌ها گزارش دهند.

کاربردهای اصلی:
• ثبت اطلاعات و عکس فرد گمشده برای اطلاع‌رسانی عمومی
• جستجو در میان پرونده‌های ثبت‌شده برای شناسایی افراد
• جستجوی هوشمند بر اساس عکس برای تطبیق چهره‌ها
• گزارش‌دهی سریع در صورت مشاهده فرد گمشده
• تأیید پیدا شدن توسط خانواده یا گزارش‌دهنده اصلی
• نظارت و مدیریت پرونده‌ها توسط تیم مدیریت سامانه

تمام گزارش‌ها پیش از انتشار توسط تیم مدیریت بررسی و تأیید می‌شوند تا صحت اطلاعات حفظ شود.`
  },
  {
